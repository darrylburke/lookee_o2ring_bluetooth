...
session_metrics(session_id, valid_hours, valid_pct, mean_spo2, baseline_spo2, t90_s, t90_pct, t88_s, odi3, odi4, hypoxic_burden, arousal_linked_h, delta_index, mean_pr, lowest_pr_30min, pr_rises6_h, movement_bouts_h, sleep_movements_h, fragmentation_index, cyclic_pct, est_sleep_window_h, est_wake_like_pct) - this dashboard's analysis, one row per recording; sleep_movements_h = movements of <=45 s inside the estimated sleep window per hour of it, comparable with sleep-lab 'large muscle group movement' counts (healthy median about 7/h)
